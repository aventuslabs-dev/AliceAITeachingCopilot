...
import { ChevronDownIcon, DocsIcon, UserCircleIcon } from "@/icons";
import { Dropdown } from "@/components/ui/dropdown/Dropdown";
import { DropdownItem } from "@/components/ui/dropdown/DropdownItem";

// Cloned from TailAdmin src/components/header/UserDropdown.tsx
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="mr-1 block font-medium text-theme-sm">Teacher account</span>
        <ChevronDownIcon
      ...
      <Dropdown isOpen={isOpen} onClose={() => setIsOpen(false)} className="mt-[17px] flex w-[260px] flex-col p-3">
        <div>
          <span className="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">
            Teacher account
          </span>
          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
            Computer Science &middot; P1&ndash;S2
          </span>
        </div>
        ...
        <ul className="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
          <li>
            ...
            >
              <UserCircleIcon className="h-6 w-6 text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300" />
              Edit profile
            </DropdownItem>
          </li>
          <li>
            <DropdownItem
              ...
              className="group flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              <DocsIcon className="h-6 w-6 text-gray-500 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300" />
              Support
            </DropdownItem>
          </li>
        </ul>
